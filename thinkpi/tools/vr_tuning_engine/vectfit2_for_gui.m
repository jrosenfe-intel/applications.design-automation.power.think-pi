function [SER,poles,rmserr,fit,f,Ns,freq ]=vectfit2_for_gui(f,s,poles,weight,VF,run);
%
...
if VF.spy1==1
  ...
  %else %logx=0
    ...
    %end
  %end
  %figure(3+run),xlabel('Frequency [Hz]'); ylabel('Magnitude'); 
  %figure(3+run), title('Sigma and sigma*f')
  %if VF.legend==1
